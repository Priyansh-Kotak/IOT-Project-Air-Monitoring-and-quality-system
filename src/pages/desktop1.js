  ...
  return (
    <>
      <div className="relative bg-white w-full h-[134.56rem] overflow-hidden text-left text-[1.94rem] text-lightcyan-100 font-urbanist">
        <div className="absolute top-[68.94rem] left-[-10.56rem] w-[110.84rem] h-[85.69rem]">
          <img
            className="absolute top-[0rem] left-[10.56rem] w-[110.84rem] h-[85.69rem]"
            alt=""
            src="/background.svg"
          />
          <div className="absolute top-[18.81rem] left-[61.5rem] w-[32.06rem] h-[38.69rem] text-center">
            ...
            <div className="absolute top-[-0.16rem] left-[31.91rem] box-border w-[0.31rem] h-[39rem] border-r-[5px] border-solid border-mediumturquoise-200" />
            <div className="absolute top-[-0.16rem] left-[16.03rem] box-border w-[0.31rem] h-[39rem] border-r-[5px] border-solid border-mediumturquoise-200" />
            <div className="absolute top-[-0.16rem] left-[0.16rem] box-border w-[0.31rem] h-[39rem] border-r-[5px] border-solid border-mediumturquoise-200" />
          ...
          <div className="absolute top-[8.06rem] left-[45.44rem] text-[4.69rem] font-medium font-taviraj">
            AQI Basics
          </div>
        </div>
        <div className="absolute top-[40.06rem] left-[0rem] bg-gray-100 w-[110rem] text-center h-[33.81rem] text-[4.38rem] text-steelblue font-lateef">
          <div className="absolute top-[5.56rem] left-[36.13rem] w-[20.71rem] h-[23.37rem] text-[6.25rem]">
            <input
            ...
            />
            <img
              className="absolute top-[16.6rem] left-[2.34rem] rounded-381xl w-[14.36rem] h-[6.19rem]"
              alt=""
              src="/line-1.svg"
            />
            <input
          ...
          <div className="absolute top-[13.06rem] left-[61.44rem] w-[18.79rem] h-[20.77rem]">
            <input
          ...
          <div className="absolute top-[1.44rem] left-[36.13rem] text-[5rem] font-medium font-taviraj text-lightcyan-200">
            Results
          </div>
        </div>
        <div className="absolute top-[-40.24rem] left-[0rem] w-[141.95rem] h-[90.61rem] text-[4.69rem] text-lightcyan-300 font-taviraj -z-0">
          <img
            className="absolute top-[40.24rem] left-[46.7rem] w-[95.25rem] h-[90.61rem] z-auto"
            alt=""
            // src="/photo.svg"
          />
        ...
        <div className="absolute top-[73.81rem] left-[-0.06rem] box-border w-[90.13rem] h-[0.13rem] border-t-[2px] border-solid border-mediumturquoise-100" />
        <img
          className="absolute top-[39.94rem] left-[0rem] w-[90rem] h-[0.13rem]"
          alt=""
          src="/divider-1.svg"
        />
      </div>
